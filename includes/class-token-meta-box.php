...
class PML_Token_Meta_Box
{
    ...
    public function enqueue_scripts_and_styles( string $hook_suffix ): void
    {
        ...
        wp_enqueue_style( PML_FLATPICKR_HANDLE );
        wp_enqueue_style( PML_SELECT2_HANDLE );
        wp_enqueue_script( PML_FLATPICKR_HANDLE );
        wp_enqueue_script( PML_SELECT2_HANDLE );
        ...
        wp_enqueue_script( PML_PLUGIN_SLUG . '-token-meta-box-js', PML_PLUGIN_URL . 'admin/assets/js/token-meta-box.js', [ 'jquery', 'wp-util', 'wp-i18n', PML_FLATPICKR_HANDLE, PML_SELECT2_HANDLE, PML_PLUGIN_SLUG . '-admin-common-utils-js' ], PML_VERSION, true );
