<?php
/**
 * Build Script: Generate Class Map for Protected Media Links (PML).
...
else
{
    ksort( $class_map );
    $output_content = "<?php\n";
    $output_content .= "// Protected Media Links (PML) Class Map - Auto-generated by build/generate-pml-class-map.php\n";
    $output_content .= "// Plugin: Protected Media Links\n";
